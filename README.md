...
**Status: built and working.** 654 tests (656 on Linux), including multi-process concurrency and hook-safety
...
cargo test                       # all 654 tests (656 on Linux)
...
| Read | For |
|---|---|
| [`docs/DECISIONS.md`](docs/DECISIONS.md) | **The specification.** D1–D119, each recording what was rejected and why |
