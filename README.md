...
**Status: built and working.** 604 tests (606 on Linux), including multi-process concurrency and hook-safety
...
| Read | For |
|---|---|
| [`docs/DECISIONS.md`](docs/DECISIONS.md) | **The specification.** D1–D110, each recording what was rejected and why |
