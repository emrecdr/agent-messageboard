...
**Status: built and working.** 623 tests (625 on Linux), including multi-process concurrency and hook-safety
...
cargo test                       # all 623 tests (625 on Linux)
...
| Read | For |
|---|---|
| [`docs/DECISIONS.md`](docs/DECISIONS.md) | **The specification.** D1–D111, each recording what was rejected and why |
