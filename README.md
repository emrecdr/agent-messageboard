...
**Status: built and working.** 709 tests (711 on Linux), including multi-process concurrency and hook-safety
...
cargo test                       # all 709 tests (711 on Linux)
...
| Read | For |
|---|---|
| [`docs/DECISIONS.md`](docs/DECISIONS.md) | **The specification.** D1–D134, each recording what was rejected and why |
