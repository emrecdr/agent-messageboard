...
**Status: built and working.** 674 tests (676 on Linux), including multi-process concurrency and hook-safety
...
cargo test                       # all 674 tests (676 on Linux)
...
| Read | For |
|---|---|
| [`docs/DECISIONS.md`](docs/DECISIONS.md) | **The specification.** D1–D126, each recording what was rejected and why |
