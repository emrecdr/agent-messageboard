...
**Status: built and working.** 655 tests (657 on Linux), including multi-process concurrency and hook-safety
...
cargo test                       # all 655 tests (657 on Linux)
...
| Read | For |
|---|---|
| [`docs/DECISIONS.md`](docs/DECISIONS.md) | **The specification.** D1–D120, each recording what was rejected and why |
