...
**Status: built and working.** 638 tests (640 on Linux), including multi-process concurrency and hook-safety
...
cargo test                       # all 638 tests (640 on Linux)
...
| Read | For |
|---|---|
| [`docs/DECISIONS.md`](docs/DECISIONS.md) | **The specification.** D1–D113, each recording what was rejected and why |
