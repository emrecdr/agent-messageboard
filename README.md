...
**Status: built and working.** 668 tests (670 on Linux), including multi-process concurrency and hook-safety
...
cargo test                       # all 668 tests (670 on Linux)
...
| Read | For |
|---|---|
| [`docs/DECISIONS.md`](docs/DECISIONS.md) | **The specification.** D1–D124, each recording what was rejected and why |
