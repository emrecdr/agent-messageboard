...
**Status: built and working.** 498 tests, including multi-process concurrency and hook-safety
...
| Read | For |
|---|---|
| [`docs/DECISIONS.md`](docs/DECISIONS.md) | **The specification.** D1–D100, each recording what was rejected and why |
